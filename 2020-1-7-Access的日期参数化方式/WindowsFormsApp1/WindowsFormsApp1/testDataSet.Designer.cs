...
namespace WindowsFormsApp1 {
    ...
    public partial class testDataSet : global::System.Data.DataSet {
        ...
        public partial class table1DataTable : global::System.Data.TypedTableBase<table1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public table1Row Addtable1Row(string name, string age, System.DateTime time) {
            ...
            public string age {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“table1”中列“age”的值为 DBNull。", e);
                    }
                }
                set {
            ...
            public System.DateTime time {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("表“table1”中列“time”的值为 DBNull。", e);
                    }
                }
                set {
    ...
    public partial class table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `table1` WHERE ((`ID` = ?) AND ((? = 1 AND `name` IS NULL) OR (`name`" +
                " = ?)) AND ((? = 1 AND `age` IS NULL) OR (`age` = ?)) AND ((? = 1 AND `time` IS " +
                "NULL) OR (`time` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `table1` (`name`, `age`, `time`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `table1` SET `name` = ?, `age` = ?, `time` = ? WHERE ((`ID` = ?) AND ((? =" +
                " 1 AND `name` IS NULL) OR (`name` = ?)) AND ((? = 1 AND `age` IS NULL) OR (`age`" +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\bin\\Debug\\test.mdb";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, name, age, [time] FROM table1";
        ...
        public virtual int Delete(int Original_ID, string Original_name, string Original_age, global::System.Nullable<global::System.DateTime> Original_time) {
        ...
        public virtual int Insert(string name, string age, global::System.Nullable<global::System.DateTime> time) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string age, global::System.Nullable<global::System.DateTime> time, int Original_ID, string Original_name, string Original_age, global::System.Nullable<global::System.DateTime> Original_time) {
            if ((name == null)) {
